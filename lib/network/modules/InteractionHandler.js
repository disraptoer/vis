...
var NodesHandler = require("./NodesHandler").default
...
class InteractionHandler {
  ...
  onMouseMove(event) {
    ...
    if (this.popup !== undefined) {
      ...
      if (this.popup.hidden === false) {
        popupVisible = true;
        // We dont want the tooltip to move with the mouse
        //this.popup.setPosition(pointer.x + 3, pointer.y - 5);
        var node_pos
        node_pos = this.selectionHandler.getNodeAt(pointer);
        console.log("NODE POSITION" + node_pos.id);
        console.log("NODE POSITION" + NodesHandler.getPositions(node_pos.id));
        this.popup.setPosition(node_pos.x + 3, node_pos.y - 5);
