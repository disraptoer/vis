...
class NodesHandler {
   ...
   * @private
   */
  easeNodes(nodes, doNotEmit = false) {
    let oldNodesData = this.body.data.nodes;

    var animationEasingFunction = "easeInOutQuad";
    var animationDuration = 1000;
    var animationSpeed = 1 / (60 * animationDuration * 0.001) || 1 / 60; // 60 for 60 seconds, 0.001 for milli's
    // if (nodes instanceof DataSet || nodes instanceof DataView) {
    //   this.body.data.nodes = nodes;
    // }
    // else if (Array.isArray(nodes)) {
